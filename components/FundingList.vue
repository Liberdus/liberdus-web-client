<template>
  ...
  <div>
    ...
    <a-row type="flex" justify="space-around" align="middle" class="funding-button-row" :gutter="[0, 16]">
      <a-col span="24">
        <a-row type="flex" justify="space-around" align="middle">
          <a-button type="primary" shape="round" icon="plus-square" size="large" @click="$router.push('/economy/new/funding')">
      ...
      <a-col span="24">
        <a-row type="flex" justify="space-around" align="middle">
          <a-button type="primary" shape="round" icon="check-square" size="large" @click="$router.push('/vote/funding')">
            Vote Fundings
          </a-button>
        </a-row>
      </a-col>
      ...
      <a-col span="24">
        <a-row type="flex" justify="space-around" align="middle">
          <a-button type="primary" shape="round" icon="fund" size="large" @click="$router.push('/vote/success')">
            Funded Projects
          </a-button>
        </a-row>
      </a-col>
...
export default {
  ...
  computed: {
    ...
    allCompletedProposalList() {
      const combinedDevProposals = concat(this.getActiveDevProposals, this.getCompletedDevProposals);
